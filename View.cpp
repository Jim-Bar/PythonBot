...
float const View::edgesWidth;
float const View::defaultMargin;

View::View(Model const& model, sf::Color edgesColor)
{
...
void
View::draw(std::vector<Object*> const& objects)
{
...
void
View::add_explosion(sf::Vector2f const& position, float radius)
{
...
void
View::add_bot_explosion(sf::Vector2f const& position, float radius)
{
